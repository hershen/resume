...
%---------------------------------------------------------
  \cventry
    ...
    {\fbox{Python} \fbox{C++} \fbox{Bash} \fbox{NumPy} \fbox{pandas} \fbox{Matplotlib} \fbox{Machine learning} \fbox{Batch processing} \fbox{Statistics} \fbox{\LaTeX}} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Searched for a new fundamental particle in 50 TBytes of data collected by the BaBar detector.}
        \item {Bayesian statistical methods are used to exclude possible values of the particles parameters.}
        \item {The limits improved by X3 -- X10 compared to best current published limits.}
        \item {Used machine learning methods separate between particle types.}
      \end{cvitems}
    }
